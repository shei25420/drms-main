                                        ...
                                        <div class="card" style="max-width: 200px;">
                                            <div class="card-body p-0">
                                                <div class="card bg-dark text-white">
                                                    <img width="200" height="200" src="{{ asset('/assets/images/payment/stripe.webp')  }}" class="card-img img-fluid" alt="stripe payment">
                                                </div>
                                            </div>
                                        </div>
                                    </a>
...
{{--                            <i class="ti-credit-card" style="font-size: x-large; color:#f75f5f;"></i> Credit Card--}}
{{--                        </button>--}}
{{--                    </h2>--}}
