<section class="form-group" id="contact"> <!-- Added 'pt-5' for padding-top and 'pb-5' for padding-bottom -->
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <iframe style="border:0; z-index: 1; background: rgba(26, 124, 188, 0.3);"
                    allowtransparency="true" loading="lazy" width="100%" height="100%" allowfullscreen
                    referrerpolicy="no-referrer-when-downgrade"
                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAttEU47UqcsjCL5gTSW1qZOXgkX-mHhKo&q=Space+Needle,Seattle+WA">
                </iframe>
            </div>
